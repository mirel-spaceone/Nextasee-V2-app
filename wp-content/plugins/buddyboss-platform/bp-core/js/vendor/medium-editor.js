    ...
    var Util = {
        ...
        * Take an element, and break up all of its text content into unique pieces such that:
        ...
        insertHTMLCommand: function (doc, html) {
            ...
            // If we're monitoring calls to execCommand, notify listeners as if a real call had happ.nextasee.comd
...
(function () {
    ...
    Events.prototype = {
        ...
        updateFocus: function (target, eventObj) {
            ...
            // For clicks, we need to know if the mousedown that caused the click happ.nextasee.comd inside the existing focused element
        ...
        handleDocumentSelectionChange: function (event) {
            ...
            if (event.currentTarget && event.currentTarget.activeElement) {
                ...
                // happ.nextasee.comd within a contenteditable owned by this instance of MediumEditor
                this.base.elements.some(function (element) {
            ...
            for (var i = 0; i < spans.length; i++) {
                ...
                if (spans[i].getAttribute('data-href') !== textContent && nodeIsNotInsideAnchorTag(spans[i])) {
                    ...
                    if (spans[i].getAttribute('data-href') === trimmedTextContent) {
                        ...
                        // Some editing has happ.nextasee.comd to the span, so just remove it entirely. The user can put it back
